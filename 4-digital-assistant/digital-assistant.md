...
3. Create policy for ODA to access AI Agent
	...
	- create new policy agext_oda:
        ...
        - replace ##COMPARTMENT_OCID## with the OCID you saved when installing the AI Agent (in Task 2, step 4)
        - replace ##ODA_OCID## with the OCID you saved when installing ODA
...
nano settings.js
```
   - The hostname part of your ODA console (without htpps://)
   - The Channel Id copied in the previous step

   ![WebSettings](images/odaWebSettings.png)

5. In your browser open the web-widget with http://##BASTION-IP##
